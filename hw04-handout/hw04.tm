...
<\body>
  ...
  <math|S<rsub|r><around*|(|n|)>=<big|sum><rsup|log n><rsub|i=0>log
  n\<times\>k<rsub|k>\<in\>O<around*|(|<around*|(|log n|)><rsup|2>|)>>
  ...
  <\math>
    ...
    S<rsub|rebalance><around*|(|n|)>=k<rsub|1>+S<rsub|halves><around*|(|k<rsub|v>|)>\<times\>k<rsub|2>+S<rsub|rebalance><around*|(|<frac|n|2>|)>\<times\>k<rsub|4>
  </math>

  <math|S<rsub|r><around*|(|n|)>=<big|sum><rsup|log
  n><rsub|i=0>k<rsub|k>\<in\>O<around*|(|<around*|\<nobracket\>|log
  n|)><rsup|>|\<nobracket\>>>
